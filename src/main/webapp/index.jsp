...
try
{
	...
	String dbName = "water_services";
	String dbUserName = "rahul";
	String dbPassword = "wipro@1234";
	
	String connectionString = "jdbc:mysql://mysql-standalone:3306/" + dbName + "?user=" + dbUserName + "&password=" + dbPassword + "&autoReconnect=true&useSSL=false";
	
	Connection con=DriverManager.getConnection(connectionString); //create connection	

	//Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/water_services","rahul","wipro@1234"); //create connection
...
<body>
    ...
    <ul>
        <li><a href="http://192.168.56.20:8087/capstone/home.html">welcome Home page </a></li>
    </ul>
